...
import 'package:skillify/features/explore/request_session/presentation/widgets/schedule_picker.dart';

class OfferSessionScheduleSection extends StatelessWidget {
  const OfferSessionScheduleSection({
    super.key,
    required this.date,
    required this.time,
